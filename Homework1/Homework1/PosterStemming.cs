...
namespace Homework1
{
    // Reference: http://snowball.tartarus.org/otherlangs/english_cpp.txt
    public class PosterStemming
    {
        static string[] doubles = { "bb", "dd", "ff", "gg", "mm", "nn", "pp", "rr", "tt" };
        static string[] validLiEndings = { "c", "d", "e", "g", "h", "k", "m", "n", "r", "t" };

        static string[,] step1bReplacements =
            {
            {"eedly","ee"},
            {"ingly",""},
            {"edly",""},
        ...
        static string[,] step2Replacements =
            {
            {"ization","ize"},
            {"iveness","ive"},
            {"fulness","ful"},
        ...
        static string[,] step3Replacements =
            {
            {"ational","ate"},
            {"tional","tion"},
            {"alize","al"},
        ...
        static string[] step4Replacements =
                {"ement",
            "ment",
            "able",
            "ible",
