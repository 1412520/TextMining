...
namespace _1412503_test
{
    class Bow_tfidf
    {
        public static void CreateFeatureList(string inputFile, string stopwordFile, string outputFile)
        {
        ...
        //1412542
        //public static void BoW_tfidf(string input, string output, string featureFile, string roundFile, string stopwordFile)
        //{
        //    double[,] weight = null;
        //    List<string> docList;
        ...
        //    try
        //    {
        //        docList = FileUtils.processFileContent(input, stopwordFile);
